...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://accounts.google.com https://apis.google.com https://*.posthog.com https://us-assets.i.posthog.com https://cdn.jsdelivr.net",
      ...
      "frame-src 'self' https://js.stripe.com https://accounts.google.com https://docs.google.com",
